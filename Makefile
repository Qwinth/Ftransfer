#############################################################################
# Makefile for building: Ftransfer
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Ftransfer1.0.0
DISTDIR = /home/anonim/projects/c/C++/Ftransfer/.tmp/Ftransfer1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main2.cpp $(DISTDIR)/
...
compiler_moc_source_make_all: main2.moc
...
main2.o: main2.cpp cpplibs/ssocket.hpp \
		cpplibs/strlib.hpp \
		cpplibs/windowsHeader.hpp \
		cpplibs/libjson.hpp \
		cpplibs/libbase64.hpp \
